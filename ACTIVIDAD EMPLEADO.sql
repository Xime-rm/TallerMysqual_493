...
#32.	Lista los nombres, apellidos y nif de los empleados que trabajan en el departamento 3.
select nombre, apellido1, apellido2, nif from empleado where codigo_departamento = 3;

#33.	Lista los nombres, apellidos y nif de los empleados que trabajan en los departamentos 2, 4 o 5.
